...
Route::prefix('admin')->group(function () {
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::controller(AdminAkademiController::class)->group(function () {
            Route::get('/akademi', 'index');
            Route::get('/akademi/create', 'create');
            Route::post('/akademi/store', 'store');
            Route::get('/akademi/detail/{id}', 'show');
            Route::get('/akademi/edit/{id}', 'edit');
            Route::patch('/akademi/update/{id}', 'update');
            Route::delete('/akademi/destroy/{id}', 'destroy');
        });
